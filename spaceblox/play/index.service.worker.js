...
/** @type {string} */
const CACHE_VERSION = '1790187943|boot-loading-1';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["index.html","index.js","index.offline.html","index.icon.png","index.apple-touch-icon.png","index.audio.worklet.js","index.audio.position.worklet.js","PressStart2P.ttf","spaceblox_ads.js","og-share.png"];
